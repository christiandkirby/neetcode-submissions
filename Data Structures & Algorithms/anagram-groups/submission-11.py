...
class Solution:
    def groupAnagrams(self, strs: List[str]) -> List[List[str]]:
        ...
        # Time Complexity : O(N * M) (Inner for loop takes as long as the length 
        # of the longest string with length N. Outer Loop loops over M strings in strs)
        
        # Space Complexity : O(M) (You can have at most M distinct 
        # strings in strs)
